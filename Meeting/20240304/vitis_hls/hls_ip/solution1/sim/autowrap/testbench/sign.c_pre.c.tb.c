...
// ==============================================================
# 1 "/home/ubuntu/FalconHLS/code_hls/sign.c"
# 1 "/home/ubuntu/FalconHLS/code_hls/sign.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/FalconHLS/code_hls/sign.c" 2
# 32 "/home/ubuntu/FalconHLS/code_hls/sign.c"
...
1, 0, 0, 1, 0, 0, 4, 3, 2, 1, 0, 0, 1, 0, 0, 2, 1, 0, 0, 1, 0, 0, 3, 2, 1, 0, 0, 1, 0, 0,
2, 1, 0, 0, 1, 0, 0};
# 33 "/home/ubuntu/FalconHLS/code_hls/sign.c" 2
# 52 "/home/ubuntu/FalconHLS/code_hls/sign.c"
unsigned ffLDL_treesize(unsigned logn)
{
# 63 "/home/ubuntu/FalconHLS/code_hls/sign.c"
 return (logn + 1) << logn;
}
...
void ffSampling_fft_it(void *samp_ctx, const fpr *tree, const fpr *t0)
{
 ...
 double *base_adr;
 base_adr = t0;
# 332 "/home/ubuntu/FalconHLS/code_hls/sign.c"
  const int n_it = 511;
...
# 719 "/home/ubuntu/FalconHLS/code_hls/sign.c"
 n = (size_t)1 << logn;
 hn = n >> 1;
 tree0 = tree + n;
...
# 745 "/home/ubuntu/FalconHLS/code_hls/sign.c"
...
void ffSampling_fft_dyntree(void *samp_ctx, fpr *t0, fpr *t1, fpr *g00, fpr *g01, fpr *g11, unsigned orig_logn, unsigned logn, fpr *tmp)
{
 size_t n, hn;
 fpr *z0, *z1;
# 786 "/home/ubuntu/FalconHLS/code_hls/sign.c"
 if (logn == 0) {
  fpr leaf;
...
void ffLDL_fft_inner_it(fpr * tree, fpr * g0, unsigned logn, fpr * tmp){
 ...
 fpr *base_adr = g0;
# 871 "/home/ubuntu/FalconHLS/code_hls/sign.c"
 int n_it = 2046;
...
# 899 "/home/ubuntu/FalconHLS/code_hls/sign.c"
void ffLDL_fft_inner(fpr * tree, fpr * g0, fpr * g1, unsigned logn, fpr * tmp)
{
 size_t n, hn;
...
# 949 "/home/ubuntu/FalconHLS/code_hls/sign.c"
...
# 984 "/home/ubuntu/FalconHLS/code_hls/sign.c"
...
void ffLDL_binary_normalize_it(fpr *tree, unsigned orig_logn, unsigned logn)
{
 ...
 for(int i = 0; i < n_it; ++i){
  n = ((size_t)1 << (logn_normalize_tree[i]));
  if (n == 1) {
...
{
 return 2 * ((size_t)1 << (logn));
}

size_t skoff_b11(unsigned logn)
{
 return 3 * ((size_t)1 << (logn));
}

size_t skoff_tree(unsigned logn)
{
 return 4 * ((size_t)1 << (logn));
}
# 1113 "/home/ubuntu/FalconHLS/code_hls/sign.c"
...
#pragma HLS INTERFACE s_axilite port=return
 ...
 poly_neg(rf, logn);
 poly_neg(rF, logn);
# 1175 "/home/ubuntu/FalconHLS/code_hls/sign.c"
 g00 = (fpr *)tmp;
 g01 = g00 + n;
 g11 = g01 + n;
 gxx = g11 + n;
...
# 1229 "/home/ubuntu/FalconHLS/code_hls/sign.c"
 ...
 unsigned logn)
{
 ...
 sqn |= -(ng >> 31);
# 1326 "/home/ubuntu/FalconHLS/code_hls/sign.c"
 int16_t s2tmp[1024];
 for (u = 0; u < n; u ++) {
...
# 1428 "/home/ubuntu/FalconHLS/code_hls/sign.c"
 sw = (uint32_t)s;
 sw ^= (sw ^ 63) & -((63 - sw) >> 31);
 s = (int)sw;
# 1443 "/home/ubuntu/FalconHLS/code_hls/sign.c"
...
# 1472 "/home/ubuntu/FalconHLS/code_hls/sign.c"
int64_t sampler(void *ctx, fpr mu, fpr isigma)
{
 sampler_context *spc;
 int64_t s;
...
#pragma HLS LOOP_TRIPCOUNT max=1
 int64_t z0, z, b;
  fpr x;
# 1519 "/home/ubuntu/FalconHLS/code_hls/sign.c"
  z0 = gaussian0_sampler(&spc->p);
  b = (int64_t)prng_get_u8(&spc->p) & 1;
  z = b + ((b << 1) - 1) * z0;
  z_fp = fpr_of(z);
# 1548 "/home/ubuntu/FalconHLS/code_hls/sign.c"
...
# 1571 "/home/ubuntu/FalconHLS/code_hls/sign.c"
void bug(double *in, double *out, double *out2, int32_t *out_int){
...
#pragma HLS array_partition variable=rng type=complete
 ...
 for (;;) {
# 1637 "/home/ubuntu/FalconHLS/code_hls/sign.c"
  sampler_context spc;
...
# 1670 "/home/ubuntu/FalconHLS/code_hls/sign.c"
 ...
 const uint16_t *hm, unsigned logn, fpr *tmp)
{
 ...
 poly_neg(b01, logn);
 poly_neg(b11, logn);
# 1717 "/home/ubuntu/FalconHLS/code_hls/sign.c"
 t0 = b11 + n;
 t1 = t0 + n;
 ...
 t0 = b01 + n;
 t1 = t0 + n;
# 1757 "/home/ubuntu/FalconHLS/code_hls/sign.c"
 for (u = 0; u < n; u ++) {
  t0[u] = fpr_of(hm[u]);
...
# 1802 "/home/ubuntu/FalconHLS/code_hls/sign.c"
 b00 = tmp;
 b01 = b00 + n;
 b10 = b01 + n;
 b11 = b10 + n;
 ...
 sqn |= -(ng >> 31);
# 1861 "/home/ubuntu/FalconHLS/code_hls/sign.c"
 s2tmp = (int16_t *)tmp;
 for (u = 0; u < n; u ++) {
  s2tmp[u] = (int16_t)-fpr_rint(t1[u]);
 }
...
# 1889 "/home/ubuntu/FalconHLS/code_hls/sign.c"
void sign_tree(int16_t sig[1024], fpr expanded_key[15360], uint16_t hm[1024], uint8_t msg[50], uint8_t seed[48])
{
...
#pragma HLS array_partition variable=rng type=complete
 ...
 i_shake256_flip(&rng);
  ...
  for(;;){
#pragma HLS LOOP_TRIPCOUNT max=1
# 1930 "/home/ubuntu/FalconHLS/code_hls/sign.c"
 sampler_context spc;
 ...
 const uint16_t *hm, unsigned logn, uint8_t *tmp2)
{
 ...
 ftmp = (fpr *)tmp;
  for(;;){
# 1973 "/home/ubuntu/FalconHLS/code_hls/sign.c"
  sampler_context spc;
