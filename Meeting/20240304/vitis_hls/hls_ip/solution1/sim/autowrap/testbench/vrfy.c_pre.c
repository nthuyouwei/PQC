# 1 "/home/ubuntu/FalconHLS/code_hls/vrfy.c"
# 1 "/home/ubuntu/FalconHLS/code_hls/vrfy.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/FalconHLS/code_hls/vrfy.c" 2
# 32 "/home/ubuntu/FalconHLS/code_hls/vrfy.c"
...
1, 0, 0, 1, 0, 0, 4, 3, 2, 1, 0, 0, 1, 0, 0, 2, 1, 0, 0, 1, 0, 0, 3, 2, 1, 0, 0, 1, 0, 0,
2, 1, 0, 0, 1, 0, 0};
# 33 "/home/ubuntu/FalconHLS/code_hls/vrfy.c" 2
# 57 "/home/ubuntu/FalconHLS/code_hls/vrfy.c"
...
{
 uint32_t z, w;
# 405 "/home/ubuntu/FalconHLS/code_hls/vrfy.c"
 z = x * y;
 w = ((z * 12287) & 0xFFFF) * 12289;
...
{
# 471 "/home/ubuntu/FalconHLS/code_hls/vrfy.c"
...
# 582 "/home/ubuntu/FalconHLS/code_hls/vrfy.c"
 ni = 4091;
 for (m = n; m > 1; m >>= 1) {
  ni = mq_rshift1(ni);
 }
...
mq_poly_tomonty(uint16_t *f, unsigned logn)
{
 ...
 n = (size_t)1 << logn;
 for (u = 0; u < n; u ++) {
  f[u] = (uint16_t)mq_montymul(f[u], 10952);
 }
}
...
void test_vrfy_inner(const uint16_t h[1024], const char sig_in[4099], const char msg_in[9], const char nonce_in[65])
{
 unsigned logn = 10;
 ...
 h2 = (uint16_t *)tmp;
  ...
  nonce = tmp;
  nonce_len = hextobin(nonce, tlen, nonce_in);
  i_shake256_init(&sc);
  i_shake256_inject(&sc, nonce, nonce_len);
  i_shake256_inject(&sc, (const uint8_t *)msg_in, 8);
  i_shake256_flip(&sc);
 ...
 const uint16_t *h, unsigned logn, uint8_t *tmp)
{
 ...
 for (u = 0; u < n; u ++) {
  ...
  w = (int32_t)tt[u];
  w -= (int32_t)(12289 & -(((12289 >> 1) - (uint32_t)w) >> 31));
...
# 949 "/home/ubuntu/FalconHLS/code_hls/vrfy.c"
 mq_NTT(tt, logn);
 mq_NTT(h, logn);
 r = 0;
 for (u = 0; u < n; u ++) {
