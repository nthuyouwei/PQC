...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.keygen.autotvin_gmem0.dat"
         "c.keygen.autotvin_f_out.dat"
         "c.keygen.autotvin_g_out.dat"
         "c.keygen.autotvin_F_upper_out.dat"
         "c.keygen.autotvin_G_upper_out.dat"
         "c.keygen.autotvin_h_out.dat"
         "c.keygen.autotvin_seed.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.keygen.autotvout_gmem0.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
