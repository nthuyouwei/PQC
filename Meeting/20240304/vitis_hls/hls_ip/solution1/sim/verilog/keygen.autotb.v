...
`define AUTOTB_DUT      keygen
`define AUTOTB_DUT_INST AESL_inst_keygen
`define AUTOTB_TOP      apatb_keygen_top
`define AUTOTB_LAT_RESULT_FILE "keygen.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "keygen.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_keygen_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 50.00

`define AESL_DEPTH_gmem0 1
`define AESL_DEPTH_f_out 1
`define AESL_DEPTH_g_out 1
`define AESL_DEPTH_F_upper_out 1
`define AESL_DEPTH_G_upper_out 1
`define AESL_DEPTH_h_out 1
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.keygen.autotvin_gmem0.dat"
`define AUTOTB_TVIN_f_out_out_wrapc  "../tv/rtldatafile/rtl.keygen.autotvin_f_out.dat"
`define AUTOTB_TVIN_g_out_out_wrapc  "../tv/rtldatafile/rtl.keygen.autotvin_g_out.dat"
`define AUTOTB_TVIN_F_upper_out_out_wrapc  "../tv/rtldatafile/rtl.keygen.autotvin_F_upper_out.dat"
`define AUTOTB_TVIN_G_upper_out_out_wrapc  "../tv/rtldatafile/rtl.keygen.autotvin_G_upper_out.dat"
`define AUTOTB_TVIN_h_out_out_wrapc  "../tv/rtldatafile/rtl.keygen.autotvin_h_out.dat"
`define AUTOTB_TVIN_seed_out_wrapc  "../tv/rtldatafile/rtl.keygen.autotvin_seed.dat"
`define AUTOTB_TVOUT_gmem0  "../tv/cdatafile/c.keygen.autotvout_gmem0.dat"
`define AUTOTB_TVOUT_gmem0_out_wrapc  "../tv/rtldatafile/rtl.keygen.autotvout_gmem0.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_f_out = 1;
parameter LENGTH_g_out = 1;
parameter LENGTH_F_upper_out = 1;
parameter LENGTH_G_upper_out = 1;
parameter LENGTH_h_out = 1;
parameter LENGTH_seed = 1;
parameter LENGTH_gmem0 = 3096;
...
reg end_f_out;
reg [31:0] size_f_out;
reg [31:0] size_f_out_backup;
reg end_g_out;
reg [31:0] size_g_out;
reg [31:0] size_g_out_backup;
reg end_F_upper_out;
reg [31:0] size_F_upper_out;
reg [31:0] size_F_upper_out_backup;
reg end_G_upper_out;
reg [31:0] size_G_upper_out;
reg [31:0] size_G_upper_out_backup;
reg end_h_out;
reg [31:0] size_h_out;
reg [31:0] size_h_out_backup;
reg end_seed;
reg [31:0] size_seed;
reg [31:0] size_seed_backup;
